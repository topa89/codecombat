module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  ...
  new_home:
   slogan: "Изучайте программирование играючи!"
    classroom_edition: "Кем вы являетесь:"
    learn_to_code: "Кем вы являетесь:"
    teacher: "Учитель"
    student: "Студент"
    play_now: "Играть"
    im_a_teacher: "Я учитель"
    im_a_student: "Я студент"
    learn_more: "Узнать подробнее"
    classroom_in_a_box: "Все что нужно для преподавания информатики."
    codecombat_is: "CodeCombat это платформа для студентов, которая позволяет изучать информатику в игровом режиме."
    our_courses: "Наши курсы специально разработаны таким образом, что любой преподаватель с минимальными знаниями информатики сможет хорошо знать предмет."
    designed_with: "Разработано совместно с учителями."
