...
#    facebook: "Facebook"
#    twitter: "Twitter"
    create_a_class: "Создать свой класс:"
    other: "Другое"
    learn_to_code: "Хочу учиться!"
...
#    campaign_old_multiplayer_description: "Relics of a more civilized age. No simulations are run for these older, hero-less multiplayer arenas."
  ...
  login:
    ...
    signup_switch: "У меня нет аккаунта"
  ...
  general:
    ...
    commit_msg: "Сопроводительное письмо."
  ...
  play_level:
    ...
    tip_compiler_ignores_comments: "Временами мне кажется что ты игнорируешь мои советы.."
    tip_understand_recursion: "Только те кто понимают рекурсию те понимают рекурсию."
    tip_life_and_polymorphism: "Открытое ПО является полностью полиморфной гетерогенной структурой. Все типы приветствуются!"
  ...
  subscribe:
    ...
    confirm_unsubscribe: "Подтвердите отмену подписки"
  ...
  about:
    main_title: "Если вы хотите научиться программировать, вам придется писать код."
    main_description: "В CodeCombat вы потратите время с пользой!"
    mission_link: "Миссии"
    team_link: "Команда"
    ...
    press_link: "Нажми"
    mission_title: "Наша цель: сделать программирование доступным любому студенту на Земле."
    mission_description_1: "<strong>Программирование - это магия.</strong>. Программирование - это реализация ваших мыслей и задумок. Мы даем возможность применять магию нашим ученикам с помощью пальцев путем написания <strong>кода.</strong>." # {change}
    mission_description_2: "Оказывается, это позволяет им обучаться быстрее. Намного быстрее. Это больше похоже на разговор, чем на чтение руководства. Мы хотим донести наши знания и принцип работы до каждой школы <strong>every student</strong>, потому что у каждого есть шанс научиться программировать." # {change}
    team_title: "Познакомиться с командой CodeCombat"
    team_values: "Мы ценим открытое общение, где важную роль играет генерация идей. Наш подход основан на исследованиях, процесс ориентирован на достижение ощутимых результатов. Мы ценим каждого, начиная с авторов перевода текстов на GitHub и заканчивая нашим директором."
   ...
   maka_blurb: "Рассказчик"
    rob_title: "Программист"
    rob_blurb: "Отвечает за написание кода"
    josh_c_title: "Гейм-дизайнер"
    josh_c_blurb: "Дизайн игр"
    robin_title: "Дизайн интерфейса"
    robin_blurb: "Строительные леса"
